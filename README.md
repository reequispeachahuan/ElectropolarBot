...
python -m app.main --mode once --keywords "solar,luminaria solar,panel solar" --regions "Lima,Arequipa"
```
...
```bash
python -m app.main --mode once
python -m app.main --mode once --keywords "solar,luminaria solar,panel solar" --regions "Lima,Arequipa" --send-telegram
```
...
- Permite elegir regiones desde un multiselect antes de la búsqueda.
- Permite editar palabras clave desde un campo de texto antes de la búsqueda.
- Incluye botón **"Abrir interfaz de resultados"** para ver los resultados obtenidos sin usar terminal.
